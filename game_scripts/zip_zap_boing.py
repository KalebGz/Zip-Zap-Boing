...
class ZipZapBoing():
    ...
    def make_move(self, speech=False):
...
def play():
    ...
    for errorpass in range(1):
        ...
        # Create new game
        game = ZipZapBoing(N, gameplay, error, errorpass)
        ...
        while not rospy.is_shutdown():
            ...
            if not play_game:
                ...
                game.make_move(speech=True)
            
            #increment counter
            i += 1

        ledger = game.game_ledger
